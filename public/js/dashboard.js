...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props) {
    ...
    //Computed
    var tareaAtrasada = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      return props.task.task_lated && props.task.task_status_id !== 3 ? 'bg-danger text-white' : '';
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, _ref) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$api$get, data, task_statuses, errors;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _api__WEBPACK_IMPORTED_MODULE_2__["default"].get('/task-statuses');
            case 3:
    ...
    var _useFormularios = (0,_composables_useFormularios__WEBPACK_IMPORTED_MODULE_1__["default"])(),
      errores = _useFormularios.errores,
      loading = _useFormularios.loading,
      manejoErroresApi = _useFormularios.manejoErroresApi;

    //Data
    var taskStatuses = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
    var submitTask = /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _ref4, data, message, task_status, _manejoErroresApi, erroresApi, valoresAlerta;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return _api__WEBPACK_IMPORTED_MODULE_2__["default"].put("/tasks/".concat(props.task.id), props.task);
              case 6:
              ...
              case 9:
                _context2.next = 11;
                return _api__WEBPACK_IMPORTED_MODULE_2__["default"].post("/tasks", props.task);
              case 11:
                _context2.t0 = _context2.sent;
              case 12:
                _ref4 = _context2.t0;
                data = _ref4.data;
                message = data.message, task_status = data.task_status;
                _context2.next = 17;
              ...
              case 21:
                ...
                _manejoErroresApi = manejoErroresApi(_context2.t1, props.task), erroresApi = _manejoErroresApi.erroresApi, valoresAlerta = _manejoErroresApi.valoresAlerta;
    ...
    return {
      ...
      tituloCard: (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
        return props.task.id ? 'Editar tarea' : 'Agregar tarea';
      }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    var abrirModal = function abrirModal() {
      var taskEdit = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      if (taskEdit) {
        task.value = taskEdit;
      }
      verModal.value = true;
    ...
    return {
      ...
      cerrarAlertaGlobal: function cerrarAlertaGlobal() {
        return store.commit('alerta/RESETEAR_ALERTA');
      },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_card, {
    clasesCard: "mb-3 ".concat($setup.tipoTask, " ").concat($setup.tareaAtrasada, " border-0 shadow-sm"),
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return _ctx.$emit('edit-task', $props.task);
    })
  }, {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("form", {
    ...
    header: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h4", _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.tituloCard), 1 /* TEXT */)];
    }),
    ...
    body: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [_hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        ...
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return $props.task.description = $event;
        }),
        disabled: $setup.loading
      }, null, 8 /* PROPS */, _hoisted_4), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $props.task.description]]), $setup.errores.description ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_errores_formulario, {
        key: 0,
        errores: $setup.errores.description
        ...
        "class": "w-100",
        modelValue: $props.task.due_date,
        "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
          return $props.task.due_date = $event;
        }),
        type: "date",
        ...
        disabled: $setup.loading
      }, null, 8 /* PROPS */, ["modelValue", "disabled"]), $setup.errores.due_date ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_errores_formulario, {
        key: 0,
        errores: $setup.errores.due_date
      }, null, 8 /* PROPS */, ["errores"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $props.task.id ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, [_hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
        "class": "form-select",
        disabled: $setup.loading,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
          return $props.task.task_status_id = $event;
        })
      }, [_hoisted_10, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.taskStatuses, function (_ref) {
        var id = _ref.id,
          name = _ref.name;
      ...
      }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_9), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $props.task.task_status_id]]), $setup.errores.task_status_id ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_errores_formulario, {
        key: 0,
        errores: $setup.errores.task_status_id
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [$setup.alertaGlobal.ver ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_alerta, {
    ...
    onCerrarAlerta: _cache[0] || (_cache[0] = function ($event) {
      return $setup.cerrarAlertaGlobal();
    })
    ...
    body: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$setup.loading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_spinner, {
        ...
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_task, {
          key: taskTodo.id,
          task: taskTodo,
          onEditTask: $setup.abrirModal
        }, null, 8 /* PROPS */, ["task", "onEditTask"]);
      }), 128 /* KEYED_FRAGMENT */))]))];
    }),
